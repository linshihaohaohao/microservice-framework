package cn.com.bluemoon.utils.encrypt;
...
//			LogUtil.info("明文:" + plaintext);
	 ...
	 * @return
	 */
	public  static  String  md5(String str,String encodeStr) {
		try {
			str = new String(str.getBytes(encodeStr));
		} catch (UnsupportedEncodingException e) {
			e.printStackTrace();
		}
		return MD5Implementor.MD5Encode(str);
	}
}