...
<body>
    ...
    <div class="nui-fit" style="padding:0px 10px 10px 10px;">
	    ...
	    url="<%=request.getContextPath()%>/menu/queryMenus"  idField="menu_id" allowResize="false"
	    sizeList="[10,20,50,100]" multiSelect="true" onrowdblclick="edit()" onselectionchanged="selectionChanged" allowCellSelect="false">
		    <div property="columns">
		        ...
		        <div field="ifleaf" width="100" headerAlign="center" allowSort="false" renderer="onIsLeafRenderer">是否叶子菜单</div>
