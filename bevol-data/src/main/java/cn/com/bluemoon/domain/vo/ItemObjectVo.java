...
import cn.com.bluemoon.domain.model.TbBevolItem;

import java.util.List;

/**
 * @ClassName: ItemObjectVo
 * @Description:
...
public class ItemObjectVo {
    private TbBevolItem goods;


    private List<ItemSafetyVo> safety;

    private List<ItemEffectVo> effect;
    ...
    private String categoryCateId;

    private Integer[] srcCpsIds;
    ...
    public String getCategoryCateId() {
        return categoryCateId;
    }

    public void setCategoryCateId(String categoryCateId) {
        this.categoryCateId = categoryCateId;
    }

    public Integer[] getSrcCpsIds() {
        return srcCpsIds;
    }

    public void setSrcCpsIds(Integer[] srcCpsIds) {
        this.srcCpsIds = srcCpsIds;
    }

    public TbBevolItem getGoods() {
        return goods;
    }

    public void setGoods(TbBevolItem goods) {
        this.goods = goods;
    }
    ...
    public List<ItemSafetyVo> getSafety() {
        return safety;
    }

    public void setSafety(List<ItemSafetyVo> safety) {
        this.safety = safety;
    }

    public List<ItemEffectVo> getEffect() {
        return effect;
    }

    public void setEffect(List<ItemEffectVo> effect) {
        this.effect = effect;
    }
}
