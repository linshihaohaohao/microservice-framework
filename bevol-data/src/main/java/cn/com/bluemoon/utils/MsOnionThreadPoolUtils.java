 ...
 */
public class MsOnionThreadPoolUtils {
     ...
     *  固定大小线程池 默认20个,退款专用
     */
    private static ExecutorService fixedThreadPool2 = Executors.newFixedThreadPool(10);
     ...
     * @return 线程池
     */
    public static ExecutorService getFixedThreadPool2() {
     ...
     * 关闭固定大小线程池
     */
    public static void shutDownFixedThreadPool2() {
