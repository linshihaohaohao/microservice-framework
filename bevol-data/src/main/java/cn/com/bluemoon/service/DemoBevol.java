 ...
 */
public class DemoBevol implements PageProcessor {
    ...
    public DemoBevol(String urlPattern) {
        this.site = Site.me();
    ...
    public static void main(String[] args) {
        Spider.create(new DemoBevol("http://www.cosdna.com/chs/product.php?q="+"眼影")).run();
    }
